...
namespace ObjectDesign.Brock.Controls.BindingCreators
{
    ...
    public class TextBoxBaseSettingBindingCreatorFactory : BindingCreatorFactory<UIElementSetting>
    {
        ...
        {
            return unit.DesigningObject.GetType() == typeof(TextBoxBaseSetting);
        }
    }
}
