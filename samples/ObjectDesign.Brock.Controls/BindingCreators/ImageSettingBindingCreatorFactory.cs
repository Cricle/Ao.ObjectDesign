...
namespace ObjectDesign.Brock.Controls.BindingCreators
{
    ...
    public class ImageSettingBindingCreatorFactory : BindingCreatorFactory<UIElementSetting>
    {
        ...
        {
            yield return new ImageSettingBindingCreator(unit, state);
        }

        public override bool IsAccept(IDesignPair<UIElement, UIElementSetting> unit, IBindingCreatorState state)
        {
            return unit.DesigningObject.GetType() == typeof(ImageSetting);
        }
    }
}
